...
@Entity
@NamedQuery(name = "HQL_INSERT_QUERY",
query = "INSERT INTO in.neuralnet.model.PremiumInsurance(pid,Policyname,CompanyName,docommencement,version,created_at,updated_at,tenure) SELECT i.pid,i.Policyname,i.CompanyName,i.docommencement,i.version,i.created_at,i.updated_at,i.tenure FROM in.neuralnet.model.Insurance as i WHERE i.tenure>=:Atenure")
